...
'user strict';
module.exports.signupTemplate = async (data) => {
   return `
    <head>
                                      ...
                                      <tbody>
										...
										<tr>
                                              <td align="left" style="background:#FFFFFF;">
                                                ...
                                                We are excited to provide our valued partners a more efficient way to communicate the benefits of Liberty Mutual’s auto 
                                                and home program to eligible employees.  
                                                Here you will be able to obtain auto & home communication material, supplemental program information, videos, and FAQs.<br/> <br/> 
                                                
                                                Please log-in using the following credentials:<br/> <br/> 

                                                Web URL : ${data.web_url}  <br/> 
